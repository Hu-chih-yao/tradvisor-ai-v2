    ...
    <div className="flex h-[100dvh] overflow-hidden bg-white dark:bg-neutral-900">
      ...
      {mobileSidebarOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          {/* Backdrop */}
          <div
            className="absolute inset-0 bg-black/30 dark:bg-black/50 animate-fadeInOverlay"
            onClick={() => setMobileSidebarOpen(false)}
          />
          {/* Sidebar panel */}
          <div className="absolute top-0 left-0 bottom-0 w-[17rem] animate-slideInLeft">
            <ChatSidebar
              currentSessionId={sessionId}
              onSelectSession={handleSelectSession}
              onNewChat={handleNewChat}
        ...
        <header className="h-14 px-5 flex items-center justify-between shrink-0 z-20 border-b border-neutral-200/60 dark:border-neutral-800">
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="lg:hidden rounded-lg p-1.5 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-neutral-800 dark:hover:text-neutral-300 transition-colors"
            >
